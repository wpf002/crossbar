...
/**
 * Tier 2 — "Momentum"
 * Chases recent direction. The thesis: information arrives in clusters and
 * prices typically undershoot the full impact, so following the move is +EV.
 */
export const momentum: Bot = {
  name: 'bot_momentum',
